		...
		<div class="container-fluid">
			...
			<div class="container-fluid">
				...
				<c:forEach items="${hList }" var="p">
					<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
						<a href="${pageContext.request.contextPath }/product/getById.do?pid=${p.pid}">
							<img src="${pageContext.request.contextPath}/${p.pimage}" width="130" height="130" style="display: inline-block;">
						</a> 
						
						<p><a href="${pageContext.request.contextPath }/product/getById.do?pid=${p.pid}" style='color:#666'>${fn:substring(p.pname,0,10) }...</a></p>
			...
			<div class="container-fluid">
				...
				<div style="text-align: center;margin-top: 5px;margin-bottom:20px;">
					Copyright &copy; 2017-2020   XX商城 版权所有
				</div>
			</div>
		</div>
	</body>

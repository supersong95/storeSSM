...
<html>
	...
	<jsp:include page="/jsp/head.jsp"></jsp:include>
		...
		<div class="container">
			<div class="row">
				<div style="border: 1px solid #e4e4e4;width:930px;margin-bottom:10px;margin:0 auto;padding:10px;margin-bottom:10px;">
					...
					<a href="${pageContext.request.contextPath}/product/getByPage.do?cid=${param.cid }&currPage=1">${bean.category.cname}&nbsp;&nbsp;&gt;</a>
					<a>${bean.pname }</a>
				</div>
				...
				<div style="margin:0 auto;width:950px;">
					...
					<div class="col-md-6">
						<form id="formId" action="${pageContext.request.contextPath }/addCart.do" method="post">
		...
		<div style="text-align: center;margin-top: 5px;margin-bottom:20px;">
			Copyright &copy; 2005-2017 xx商城 版权所有
		</div>
